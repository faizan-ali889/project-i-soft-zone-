...
async function seed() {
  ...
  try {
    ...
    console.log('🚀 Seeding 4 Realistic Projects & Team Assignments...');

    const finalUserRes = await client.query('SELECT id, email FROM users');
    const userMap = {};
    finalUserRes.rows.forEach(r => {
    ...
    console.log('✅ 10 Employees and 4 Projects successfully seeded and assigned!');
    process.exit(0);
  } catch (err) {
